        ...
        <main className="min-h-screen bg-gray-950 text-white">
            <div className="max-w-6xl mx-auto px-4 py-32">
                ...
                <h1 className="text-4xl font-bold text-center mb-16">
                    My <span className="text-brand">Story</span>
                </h1>
                ...
                <section className="relative">
                    ...
                    {/* Vertical Line */}
                    <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-0.5 bg-brand"></div>
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="relative pl-12 md:pl-0 md:grid md:grid-cols-2 md:gap-8">
                            <div className="md:text-right md:pr-12">
                                <h3 className="text-xl font-bold text-brand">2003 — The Beginning</h3>
                        ...
                        <div className="relative pl-12 md:pl-0 md:grid md:grid-cols-2 md:gap-8">
                            <div></div>
                            <div className="md:text-right md:pr-12">
                                <h3 className="text-xl font-bold text-brand">2003-2008 - Africa Calling</h3>
                        ...
                        <div className="relative pl-12 md:pl-0 md:grid md:grid-cols-2 md:gap-8">
                            <div className="md:text-right md:pr-12">
                                <h3 className="text-xl font-bold text-brand">2008–2016 — Discovery</h3>
                        ...
                        <div className="relative pl-12 md:pl-0 md:grid md:grid-cols-2 md:gap-8">
                            ...
                            <div className="md:pl-12">
                                <h3 className="text-xl font-bold text-brand">2016–2020 — Namibia</h3>
                        ...
                        <div className="relative pl-12 md:pl-0 md:grid md:grid-cols-2 md:gap-8">
                            <div className="md:text-right md:pr-12">
                                <h3 className="text-xl font-bold text-brand">2020–Present — Canada</h3>
